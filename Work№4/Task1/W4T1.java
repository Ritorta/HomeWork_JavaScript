...
// 2. вывод в формате Фамилия И.О. возраст пол
        for (int i = 0; i < people.size(); i++) 
        {
           ...
           //  System.out.println(array[0] + " " + array[1].toUpperCase().charAt(0) + "." + array[2].toUpperCase().charAt(0) + ". " +  people.get(i + 1) + " " + people.get(i + 2));
        }
...
//         {
//             String temp = people.get(i) + " " + people.get(i + 1) + " " + people.get(i + 2);
